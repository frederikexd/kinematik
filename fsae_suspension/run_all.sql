...
-- #  Generated 2026-07-16. Paste into the Supabase SQL editor and run once.
-- #
...
-- #    2  analytics_global_counter.sql    global rolling-30d headline number
-- #    3  myth_schema.sql                 base tables (retrofitted later)
-- #    4  workspace_isolation.sql         TENANCY SPINE — required for accounts
-- #    5  workspace_members_rpc.sql       member management (needs 4)
-- #    6  workspace_invites.sql           invite links (needs 4 + 5)
-- #    7  project_history.sql             version history (needs 4)
-- #    8  master_assembly_schema.sql      optional; master-assembly (needs 4)
-- #    9  analytics_hardening.sql         optional; analytics dashboards (needs 1)
-- #
-- #  MINIMUM for accounts + invite links + CAD persistence:  steps 1,3,4,5,6.
-- #  Step 2 keeps the global analytics number correct after accounts go live.
-- #  Add 7 for history; 8/9 only if you use those features.
-- #
...
-- ==============================================================================
-- Base analytics tables/views. Independent. Runs first so later scripts can
-- build on analytics_events and retrofit workspace_id.
...
-- ==============================================================================
-- ||                2 · GLOBAL HEADLINE COUNTER (rolling 30d)                 ||
-- ==============================================================================
-- Pins the headline Analytics number to ONE global total, last 30 days, all
-- workspaces combined, same for every user. Includes an RLS-proof SECURITY
-- DEFINER accessor so the global total survives even if analytics_events is
-- ever scoped later. Run AFTER analytics_schema.sql.
-- source file: suspension/analytics_global_counter.sql
-- ------------------------------------------------------------------------------
...
-- ==============================================================================
-- ||                 4 · WORKSPACE ISOLATION (TENANCY SPINE)                  ||
-- ==============================================================================
-- Creates workspaces, workspace_members, kinematik_workspace_projects, the
-- is_workspace_member()/workspace_role() helpers, and RLS on the myth/project
-- tables. Does NOT scope analytics_events, so the global counter stays
-- global. Run AFTER analytics_schema.sql / myth_schema.sql.
...
-- ==============================================================================
-- ||                        6 · WORKSPACE INVITE LINKS                        ||
-- ==============================================================================
-- Self-serve invite-link RPCs. Calls _require_member_admin() from step 5, so
...
-- ==============================================================================
-- ||             7 · PROJECT VERSION HISTORY (snapshot-on-write)              ||
-- ==============================================================================
...
-- ==============================================================================
-- ||                  8 · MASTER ASSEMBLY SCHEMA (optional)                   ||
-- ==============================================================================
...
-- ==============================================================================
-- ||                    9 · ANALYTICS HARDENING (optional)                    ||
-- ==============================================================================
