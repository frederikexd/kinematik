...
_FROM = {
    ...
    # ---------- flexgen (compliant kinematics synthesizer) ----------
    "BladeSection":           ("flexgen", "BladeSection"),
    "FlexureBlade":           ("flexgen", "FlexureBlade"),
    "PRBChain":               ("flexgen", "PRBChain"),
    "BladeState":             ("flexgen", "BladeState"),
    "BladeLoadCase":          ("flexgen", "BladeLoadCase"),
    "EquivalentSpring":       ("flexgen", "EquivalentSpring"),
    "equivalent_spring":      ("flexgen", "equivalent_spring"),
    "coilover_downsize":      ("flexgen", "coilover_downsize"),
    "flexgen_lint":           ("flexgen", "flexgen_lint"),
    "synthesize_blade":       ("flexgen", "synthesize_blade"),
    "export_blade_stl":       ("flexgen", "export_stl"),
    "export_blade_step":      ("flexgen", "export_step"),
    "blade_layup_map":        ("flexgen", "layup_map"),
    "render_flexgen_md":      ("flexgen", "render_flexgen_md"),
    # ---------- fullcar3d ----------
    ...
    # ---------- InverseGenesis (inverse_genesis) ----------
    "TargetCurve":            ("inverse_genesis", "TargetCurve"),
    "GenesisTargets":         ("inverse_genesis", "GenesisTargets"),
    "KeepOutBox":             ("inverse_genesis", "KeepOutBox"),
    "LegalVolume":            ("inverse_genesis", "LegalVolume"),
    "GenesisThresholds":      ("inverse_genesis", "GenesisThresholds"),
    "Candidate":              ("inverse_genesis", "Candidate"),
    "GenesisResult":          ("inverse_genesis", "GenesisResult"),
    "curves_of":              ("inverse_genesis", "curves_of"),
    "genesis_solve":          ("inverse_genesis", "genesis_solve"),
    ...
    "FabricationLimits":      ("morphmesh", "FabricationLimits"),
    "PlateDomain":            ("morphmesh", "PlateDomain"),
    "fabrication_audit":      ("morphmesh", "fabrication_audit"),
    "MorphRound":             ("morphmesh", "MorphRound"),
    "MorphResult":            ("morphmesh", "MorphResult"),
    "morph_component":        ("morphmesh", "morph_component"),
    "morph_from_audit":       ("morphmesh", "morph_from_audit"),
    "render_morph_md":        ("morphmesh", "render_morph_md"),
    "MissionSpec":            ("omnicore", "MissionSpec"),
    "parse_mission":          ("omnicore", "parse_mission"),
    "OmniKnobs":              ("omnicore", "OmniKnobs"),
    "OmniResult":             ("omnicore", "OmniResult"),
    "run_omnicore":           ("omnicore", "run_omnicore"),
    "render_omni_md":         ("omnicore", "render_omni_md"),
    "twin_baseline":          ("omnicore", "twin_baseline"),
    "defect_signatures":      ("omnicore", "defect_signatures"),
    "twin_diagnose":          ("omnicore", "diagnose"),
    "heal_plan":              ("omnicore", "heal_plan"),
    "render_twin_md":         ("omnicore", "render_twin_md"),
    ...
    "ActuatorParams":       ("simulforge", "ActuatorParams"),
    "BusParams":            ("simulforge", "BusParams"),
    "Degradation":          ("simulforge", "Degradation"),
    "degradation_presets":  ("simulforge", "degradation_presets"),
    "MechatronicSolver":    ("simulforge", "MechatronicSolver"),
    "SimulForgeResult":     ("simulforge", "SimulForgeResult"),
    "run_simulforge":       ("simulforge", "run_simulforge"),
    "ForgeLint":            ("simulforge", "ForgeLint"),
    "forge_lint":           ("simulforge", "forge_lint"),
    "render_forge_md":      ("simulforge", "render_forge_md"),
...
__all__ = [
    ...
    # FlexGen — compliant kinematics synthesizer
    "BladeSection", "FlexureBlade", "PRBChain", "BladeState", "BladeLoadCase",
    "EquivalentSpring", "equivalent_spring", "coilover_downsize",
    "flexgen_lint", "synthesize_blade", "export_blade_stl",
    "export_blade_step", "blade_layup_map", "render_flexgen_md", "flexgen",
    ...
    # simulforge — unified mechatronic co-solver
    "ActuatorParams", "BusParams", "Degradation", "degradation_presets",
    "MechatronicSolver", "SimulForgeResult", "run_simulforge", "ForgeLint",
    "forge_lint", "render_forge_md", "simulforge",
    ...
    # InverseGenesis
    "TargetCurve", "GenesisTargets", "KeepOutBox", "LegalVolume",
    "GenesisThresholds", "Candidate", "GenesisResult", "curves_of",
    "genesis_solve", "build_yield", "inverse_genesis_run",
    "render_genesis_md",
