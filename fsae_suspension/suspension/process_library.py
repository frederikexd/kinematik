...
SEED_ROWS = [
    ...
    _r("Upright / Knuckle", "5-axis CNC machining (billet aluminium)", "suspension",
       ...
       "https://www.fsaeonline.com/cdsweb/gen/DownloadDocument.aspx?DocumentID=2a1b4f2e-0d2e-4f5a-9b3a-uprights",
    ...
    _r("A-arm / Wishbone", "Steel tube mitre, jig & TIG welding", "suspension",
       ...
       "https://www.fsaeonline.com/cdsweb/app/Forums.aspx?topic=wishbone-welding",
    ...
    _r("A-arm / Wishbone", "Bonded carbon tube + aluminium insert", "suspension",
       ...
       "https://www.compositesworld.com/articles/bonded-composite-tube-joints",
    ...
    _r("Rod end / Spherical bearing", "Selection, press-fit & staking", "suspension",
       ...
       "https://www.aurorabearing.com/technical/rod-end-engineering",
    ...
    _r("Pushrod / Pullrod", "Tube + threaded clevis machining", "suspension",
       ...
       "https://www.fsaeonline.com/cdsweb/app/Forums.aspx?topic=pushrod-design",
    ...
    _r("Rocker / Bellcrank", "Waterjet + CNC, double-shear mounting", "suspension",
       ...
       "https://www.fsaeonline.com/cdsweb/app/Forums.aspx?topic=rocker-design",
    ...
    _r("Hub", "Turning, splines & wheel-stud press", "suspension",
       ...
       "https://www.fsaeonline.com/cdsweb/app/Forums.aspx?topic=hub-bearing",
    ...
    _r("Coilover / Damper mount", "Sheet bracket forming & welding", "suspension",
       ...
       "https://www.fsaeonline.com/cdsweb/app/Forums.aspx?topic=damper-mount",
    ...
    _r("Anti-roll bar", "Blade ARB machining & heat treat", "suspension",
       ...
       "https://www.fsaeonline.com/cdsweb/app/Forums.aspx?topic=arb-design",
    ...
    _r("Wing element", "Wet layup / prepreg CFRP over a plug", "aero",
       ...
       "https://www.compositesworld.com/articles/the-basics-of-composite-tooling",
    ...
    _r("Wing element", "5-axis foam-core machining", "aero",
       ...
       "https://www.compositesworld.com/articles/machining-composite-cores",
    ...
    _r("Endplate / Mount", "Carbon plate cutting & bonded brackets", "aero",
       ...
       "https://www.compositesworld.com/articles/cutting-and-machining-carbon-fiber",
    ...
    _r("Undertray / Diffuser", "Large-panel composite layup", "aero",
       ...
       "https://www.compositesworld.com/articles/composite-floor-pan-fabrication",
    ...
    _r("Nose cone", "Mould + impact-attenuator integration", "aero",
       ...
       "https://www.fsaeonline.com/cdsweb/app/Forums.aspx?topic=impact-attenuator",
    ...
    _r("Drive shaft / Halfshaft", "Splined shaft turning & heat treat", "powertrain",
       ...
       "https://www.fsaeonline.com/cdsweb/app/Forums.aspx?topic=halfshaft-design",
    ...
    _r("Sprocket / Chain drive", "Waterjet + CNC, hard-anodise", "powertrain",
       ...
       "https://www.fsaeonline.com/cdsweb/app/Forums.aspx?topic=sprocket-design",
    ...
    _r("Diff mount / Carrier", "Machined carrier + bearing fit", "powertrain",
       ...
       "https://www.fsaeonline.com/cdsweb/app/Forums.aspx?topic=differential-mount",
    ...
    _r("Motor mount (EV)", "Machined plate + dowel location", "powertrain",
       ...
       "https://www.fsaeonline.com/cdsweb/app/Forums.aspx?topic=ev-motor-mount",
    ...
    _r("Accumulator segment", "Cell tabbing & spot/ultrasonic welding", "electrics",
       ...
       "https://www.fsaeonline.com/cdsweb/app/Forums.aspx?topic=accumulator-construction",
    ...
    _r("Busbar", "Copper laser/waterjet cut + tin plating", "electrics",
       ...
       "https://www.protoexpress.com/blog/busbar-design-fabrication/",
    ...
    _r("Accumulator container", "Sheet aluminium fold + rivet/weld", "electrics",
       ...
       "https://www.fsaeonline.com/cdsweb/app/Forums.aspx?topic=accumulator-container",
    ...
    _r("Wiring harness", "Layout, crimp & strain relief", "electrics",
       ...
       "https://www.fsaeonline.com/cdsweb/app/Forums.aspx?topic=wiring-harness",
    ...
    _r("Cooling plate (cells)", "CNC / friction-stir-welded cold plate", "electrics",
       ...
       "https://www.protoexpress.com/blog/liquid-cold-plate-design/",
    ...
    _r("Brake rotor / Disc", "Laser/waterjet + grinding, slotting", "brakes",
       ...
       "https://www.fsaeonline.com/cdsweb/app/Forums.aspx?topic=brake-rotor",
    ...
    _r("Caliper bracket", "Machined / waterjet double-shear mount", "brakes",
       ...
       "https://www.fsaeonline.com/cdsweb/app/Forums.aspx?topic=caliper-mount",
    ...
    _r("Brake pedal", "Machined / fabricated pedal + bias bar", "brakes",
       ...
       "https://www.fsaeonline.com/cdsweb/app/Forums.aspx?topic=brake-pedal",
    ...
    _r("Brake lines", "Hard-line bending & flaring + braided hose", "brakes",
       ...
       "https://www.fsaeonline.com/cdsweb/app/Forums.aspx?topic=brake-lines",
    ...
    _r("Spaceframe chassis", "Tube mitre, jig & TIG weld sequence", "chassis",
       ...
       "https://www.fsaeonline.com/cdsweb/app/Forums.aspx?topic=spaceframe-build",
    ...
    _r("Monocoque", "Honeycomb sandwich layup & bonding", "chassis",
       ...
       "https://www.fsaeonline.com/cdsweb/app/Forums.aspx?topic=monocoque",
    ...
    _r("Suspension mount / Bracket", "Sheet bracket + weld to frame", "chassis",
       ...
       "https://www.fsaeonline.com/cdsweb/app/Forums.aspx?topic=suspension-brackets",
    ...
    _r("Bulkhead / Firewall", "Sheet aluminium / composite panel", "chassis",
       ...
       "https://www.fsaeonline.com/cdsweb/app/Forums.aspx?topic=firewall-bulkhead",
    ...
    _r("Pedal box / Footwell", "Machined mounts + adjustable rails", "chassis",
       ...
       "https://www.fsaeonline.com/cdsweb/app/Forums.aspx?topic=pedal-box",
    ...
    _r("Radiator / Cooling duct", "Sheet/composite ducting fabrication", "cooling",
       ...
       "https://www.fsaeonline.com/cdsweb/app/Forums.aspx?topic=cooling-duct",
    ...
    _r("Coolant lines / Manifold", "Hose, AN fittings & machined manifold", "cooling",
       ...
       "https://www.fsaeonline.com/cdsweb/app/Forums.aspx?topic=cooling-plumbing",
    ...
    _r("Sensor bracket", "3D-printed / machined sensor mounts", "dataacq",
       ...
       "https://www.fsaeonline.com/cdsweb/app/Forums.aspx?topic=sensor-mounting",
    ...
    _r("Any machined aluminium part", "DFM for CNC machining", "general",
       ...
       "https://www.protolabs.com/resources/design-tips/cnc-machining-design-guidelines/",
    ...
    _r("Any composite part", "Composites manufacturing primer", "general",
       ...
       "https://www.compositesworld.com/articles/the-fundamentals-of-composite-fabrication",
    ...
    _r("Any welded steel part", "TIG welding & distortion control", "general",
       ...
       "https://www.millerwelds.com/resources/article-library/tig-welding-tips",
    ...
    _r("Any bonded joint", "Adhesive bonding best practice", "general",
       ...
       "https://www.compositesworld.com/articles/adhesive-bonding-of-composites",
    ...
    _r("Any sheet-metal part", "Bending, laser cutting & DFM", "general",
       ...
       "https://www.protolabs.com/resources/design-tips/sheet-metal-design/",
    ...
    _r("Any 3D-printed part", "FDM/SLS/SLA selection & DFAM", "general",
       ...
       "https://www.hubs.com/knowledge-base/what-is-3d-printing/",
