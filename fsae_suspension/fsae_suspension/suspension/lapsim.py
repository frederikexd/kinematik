...
state, or driver line optimisation. Those are on the roadmap and are flagged in
the UI so the number is never oversold. A QSS lap time is a strong *relative*
